from infobip_service.model.time_embedding import expand_time_feature, expand_time_features, PERIODS, PERIODS_SECONDS, create_period_normalization
...
def test_expand_time_features():
    d ={
        ...
        "COMPLETE_REGST_EVENT_DATE": torch.Tensor([1662994700.0, 1682329500.0, 1670535600.0]),
    }
