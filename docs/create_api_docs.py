...
def _generate_api_docs_for_module(root_path: Path, module_name: str) -> str:
    ...
    src = """                    - [ContactDict](api/infobip_service/asyncapi/schema/info/ContactDict.md)
"""
    dst = """                    - [ContactDict](api/infobip_service/asyncapi/schema/info/ContactDict.md)
                    - [EmailStr](api/infobip_service/asyncapi/schema/info/EmailStr.md)
"""
...
if __name__ == "__main__":
    ...
    create_api_docs(root, "infobip_service")
